...
from rag_eval.artifacts import create_artifact_store
...
from rag_eval.models import Benchmark, BenchmarkCase, BenchmarkManifest, CorpusMode
...
async def _execute_test_benchmark() -> None:
    ...
    try:
        async with session_factory() as session:
            ...
            await benchmark_repository.create_benchmark(benchmark.manifest)
            for case in benchmark.cases:
                await benchmark_repository.create_case(benchmark_id, case)
