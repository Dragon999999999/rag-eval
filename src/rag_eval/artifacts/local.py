...
class LocalArtifactStore(ArtifactStore):
    ...
    async def put(
        ...
        """Atomically write content and verify an optional expected SHA-256."""
        return self._put_sync(content, artifact_type, **kwargs)
    ...
    def _put_sync(
        ...
        handle, temporary_name = tempfile.mkstemp(dir=self._root, prefix=".artifact-")
