            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-sm">
                <span className="text-text-secondary">
                  {primaryRun.progress.completed} / {primaryRun.progress.total}{" "}
                  cases
                </span>
              ...
              <ProgressBar
                value={primaryRun.progress.percent}
                className="h-2"
              />
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {primaryRun.metrics && (
                <>
                  <MetricStat
                    label="Completed"
                    value={primaryRun.metrics.completed}
                  />
                  <MetricStat
                    label="Failed"
                  ...
                  <MetricStat
                    label="Remaining"
                    value={primaryRun.metrics.remaining}
                  />
